...
%     fv{data_idx} = stlread(sprintf('%s/%s_%.2f.%s', crop_path, data_name, dist_set{data_idx}, data_ext));
    ...
    [sData, sIndex, sColor] = uniformSubSample(fv{data_idx}.Vertices, 50, fv{data_idx}.FaceVertexCData);
...
params.markerSize = {10 10 10 10 10}';
