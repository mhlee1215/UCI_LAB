...
%----------------------------------------------------
[tri, pts, data, comments] = ply_read('merged1.ply', 'tri');
vertices = [data.vertex.x data.vertex.y data.vertex.z];
faces = tri';

poseFilePath = 'livingroom1-traj.txt';
...
h=figure; hold on;
% fv_alligned.Faces = faces2;%fv_small.faces;
% fv_alligned.Vertices = vertices2;%fv_small.vertices;
