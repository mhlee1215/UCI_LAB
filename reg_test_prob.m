...
[R5,t5,X5,S5,a5,pk5,T5,TAssigned5, TXQ5] = jrmpc_soft(V,X,'maxNumIter',refineIterMax, 'updatepriors', 0, 'r', R, 't', t, 's', S, 'initialpriors', pk');
...
[R6,t6,X6,S6,a6,pk6,T6,TAssigned6, TXQ6] = jrmpc_soft(V,Xin,'maxNumIter',maxNumIter,'gamma',0.1, 'updatepriors', 0);

params.type = 2;
params.Assigned = TAssigned6;
params.K = K;
params.interval = 1;
params.marker = marker;
params.markerSize = markerSize;
...
h = figure;
[TV] = drawTransformation(V, T6, params);
