...
data_set = {'2016-04-29.00', '2016-04-29.01', '2016-04-29.02','2016-04-29.03'};
d_size = length(data_set);

resultPath = 'results/EF_changedetection2';
mkdir(resultPath);
...
%Draw changed region
fColorSet = {[190,186,218]./255, [179,222,105]./255, [251,128,114]./255, [128,177,211]./255};
bColor = [141,211,199]./255;
...
%             clear 'h';
            ...
            paramsPlotGMMK.fcolor = fColorSet{id};
            paramsPlotGMMK.bcolor = bColor;
