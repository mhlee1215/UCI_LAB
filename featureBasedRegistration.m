function [ bestR, bestT ] = featureBasedRegistration( v_m1, c_m1, n_m1, v_m2, c_m2, n_m2, d_seeds_1, f_1, d_seeds_2, f_2, trial )
...
if ~isempty(n_m1)
    [~,~,n_m1_s] = uniformSubSample(v_m1, 15, n_m1);
%     v_m1_s = v_m1_s';
    n_m1_s = n_m1_s';
else
    n_m1_s = n_m1;
...
if ~isempty(n_m2)
    [~,~,n_m2_s] = uniformSubSample(v_m2, 15, n_m2);
%     v_m1_s = v_m1_s';
    n_m2_s = n_m2_s';
else
    n_m2_s = n_m2;
...
%     scatter3(d_seeds_1(1,:), d_seeds_1(2,:), d_seeds_1(3,:), 'r', 'filled');
    ...
    [dist, seeds, overlap, d] = voxelizer_compare(v_m1_s, c_m1_s, n_m1_s, v_m2_s_t, c_m2_s, n_m2_s, params); 
